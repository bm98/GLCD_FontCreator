...
namespace GLCD_FontCreator.FontCreators
{
  ...
  /// </summary>
  class FC_Template : FCBase
  {

    // NOTE  -  THIS IS A COPY OF GLCD_FC2_Compatible  - SERVES AS TEMPLATE - change as needed and register as new fileformat

    #region Infrastructure

    private const String c_fcName = "FC_Template";
    /// <summary>
